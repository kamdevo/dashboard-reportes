...
const Perfil = () => {
  ...
  return (
    <div className="perfil">
      ...
      {editModalOpen && (
        <EditProfileModal profile={profile} onSave={handleSaveProfile} onClose={() => setEditModalOpen(false)} />
      )}
    </div>
  )
}
    ...
    <Modal onClose={onClose} title="Editar Perfil">
      <form onSubmit={handleSubmit} className="edit-profile-form">
        ...
        <div className="form-group">
          ...
          <textarea name="biografia" value={formData.biografia} onChange={handleChange} rows="4" />
        </div>

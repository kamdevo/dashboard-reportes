            ...
            {filteredArchivos.map((archivo) => (
              <Card key={archivo.id} className="archivo-card">
                ...
                <div className="archivo-actions">
                  <button className="action-btn" onClick={() => openModal("view", archivo)} title="Ver detalles">
                    👁️
                  </button>
                  <button className="action-btn" onClick={() => window.open(archivo.url, "_blank")} title="Descargar">
                    📥
                  </button>
                  <button className="action-btn" onClick={() => openModal("edit", archivo)} title="Editar">
                    ✏️
                  </button>
                  <button className="action-btn danger" onClick={() => openModal("delete", archivo)} title="Eliminar">
                    🗑️
                  </button>
                </div>
              </Card>
            ...
            {filteredArchivos.map((archivo) => (
              <div key={archivo.id} className="archivo-row">
                ...
                <div className="col-actions">
                  ...
                  <button className="action-btn-sm" onClick={() => window.open(archivo.url, "_blank")}>
                    📥
                  </button>
                  <button className="action-btn-sm" onClick={() => openModal("edit", archivo)}>
                    ✏️
                  </button>
                  <button className="action-btn-sm danger" onClick={() => openModal("delete", archivo)}>
                    🗑️
                  </button>
                </div>
              </div>
      ...
      <form onSubmit={handleSubmit} className="archivo-form">
        ...
        <div className="form-group">
          ...
          <div
            ...
            onDrop={handleDrop}
          >
            <input type="file" onChange={handleFileSelect} className="file-input" id="file-upload" />
    ...
    <div className="archivo-details">
      ...
      <div className="archivo-info-detailed">
        ...
        <div className="archivo-actions-detailed">
          <button className="btn btn-primary" onClick={() => window.open(archivo.url, "_blank")}>
            📥 Descargar
          </button>
